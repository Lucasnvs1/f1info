...
document.getElementById('btn-standings').addEventListener('click', function () {
  ...
  const pilotos = [
    { pos: 1 , nome: "Oscar Piastri", equipe: "McLaren", pontos: 198 },
    { pos: 2, nome: "Lando Norris", equipe: "McLaren", pontos: 176 },
    { pos: 3, nome: "Max Verstappen", equipe: "Red Bull", pontos: 155 },
    { pos: 4, nome: "George Russell", equipe: "Mercedes", pontos: 136 },
    { pos: 5, nome: "Charles Leclerc", equipe: "Ferrari", pontos: 104 },
    { pos: 6, nome: "Lewis Hamilton", equipe: "Ferrari", pontos: 79 },
    { pos: 7, nome: "Kimi Antonelli", equipe: "Mercedes", pontos: 63 },
    { pos: 8, nome: "Alexander Albon", equipe: "Williams", pontos: 42 },
    { pos: 9, nome: "Esteban Ocon", equipe: "Haas", pontos: 22 },
    { pos: 10, nome: "Isack Hadjar", equipe: "Racing Bulls", pontos: 21 },
    { pos: 11, nome: "Nico Hülkenberg", equipe: "Sauber", pontos: 20 },
    { pos: 12, nome: "Lance Stroll", equipe: "Aston Martin", pontos: 14 },
    { pos: 13, nome: "Carlos Sainz", equipe: "Williams", pontos: 13 },
    { pos: 14, nome: "Pierre Gasly", equipe: "Alpine", pontos: 11 },
    { pos: 15, nome: "Yuki Tsunoda", equipe: "Red Bull", pontos: 10 },
    { pos: 16, nome: "Fernando Alonso", equipe: "Aston Martin", pontos: 8 },
    { pos: 17, nome: "Oliver Bearman", equipe: "Haas", pontos: 6 },
    { pos: 18, nome: "Liam Lawson", equipe: "Racing Bulls", pontos: 4 },
    { pos: 19, nome: "Gabriel Bortoleto", equipe: "Sauber", pontos: 0 },
...
document.getElementById('btn-constructors').addEventListener('click', function () {
  ...
  const construtores = [
    { pos: 1, equipe: "McLaren", pontos: 374 },
    { pos: 2, equipe: "Mercedes", pontos: 199 },
    { pos: 3, equipe: "Ferrari", pontos: 183 },
    { pos: 4, equipe: "Red Bull", pontos: 162 },
    { pos: 5, equipe: "Williams", pontos: 55 },
    { pos: 6, equipe: "Haas", pontos: 28 },
    { pos: 7, equipe: "Racing Bulls", pontos: 28 },
    { pos: 8, equipe: "Aston Martin", pontos: 22 },
    { pos: 9, equipe: "Sauber", pontos: 20 },
